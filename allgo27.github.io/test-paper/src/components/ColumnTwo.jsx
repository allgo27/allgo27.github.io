    ...
    <div className="ColumnTwo">
      ...
      <Block
        ...
        listOfBullets={[
          [
            <li key="PE.1">
              Researched, created, documented, and currently maintains backend
              organizational systems for the management of Our Local Bookstore.
            </li>,
            <li key="PE.2">
              Manages publication process for books, liaising between authors,
              illustrators, editors, designers, printers, and distributors.
            </li>,
            <li key="PE.3">
              Designed, built, and currently maintains payouts system for
              authors who sell their books through Beaver's Pond online.
            </li>,
            <li key="PE.4">
              Designs and builds workflows for Podio, a Customer Relationship
              Management tool.
            </li>,
            <li key="PE.5">
              Edits manuscripts, promotional materials, metadata, and other
              copy.
            </li>,
          ],
          [
      ...
      <Block
        ...
        listOfSubheads={[
          <h5>
            <a href="https://ischool.illinois.edu/degrees-programs/graduate/ms-library-and-information-science">
              University of Illinois, Urbana-Champaign
            </a>{" "}
            | Urbana-Champaign, IL (Aug. 2023 – Expected Spring 2025)
          </h5>,
          <h5>
        ...
        listOfBullets={[
          [
            <li key="E.1">M.S. in Library and Information Science</li>,
            <li key="E.2">
              Selected Coursework: Community Engagement; Accessibility in
              Library Technology; Libraries, Information, and Society
            </li>,
          ],
          [
            <li key="E.3">B.A. in English, with distinction</li>,
            <li key="E.4">B.A. in Computer Science</li>,
            <li key="E.5">
